...
class FPGA(object):
    ...
    def _FPGADownloadBitstream(self, fwFileLike):
        ...
        # a just in case item)
        inputStream += bytes("\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff", "utf-8")
